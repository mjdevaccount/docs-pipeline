...
✅ Metadata is passed to `cli/main.py` via CLI arguments
...
python cli/main.py document.md
```
...
|-----------|--------|-------|--------|
| Backend (`cli/main.py`) | ✅ 100% | ✅ 100% | ✅ |
| CLI (`cli/main.py`) | ✅ 100% | ✅ 100% | ✅ |
...
python tools/pdf/cli/main.py test.md test.pdf
```
