...
python tools/pdf/cli/main.py docs/examples/technical-white-paper.md \
  whitepaper-tech.pdf \
...
python tools/pdf/cli/main.py docs/examples/product-requirements-doc.md \
  prd-dark.pdf \
  --profile dark-pro \
  --renderer playwright \
  --generate-cover \
...
python tools/pdf/cli/main.py docs/examples/advanced-markdown-showcase.md \
