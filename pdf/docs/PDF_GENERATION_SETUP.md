...
#### Logo Support
Default logo location: `docs/REDACTEDLogo.png` (relative to project root).
...
### Logo not appearing
- Verify logo path: `docs/REDACTEDLogo.png`
...
└── docs/
    ├── REDACTEDLogo.png       # Company logo (default location)
