...
def markdown_to_pdf(md_file, output_pdf, logo_path=None, css_file=None, cache_dir=None, use_cache=True, theme_config=None, highlight_style=None, crossref_config=None, glossary_file=None, renderer='weasyprint', generate_toc=False, generate_cover=False, watermark=None, verbose=False):
    ...
    Args:
        ...
        logo_path: Optional path to logo image (default: docs/previseLogo.png)
    ...
    try:
        ...
        if renderer == 'playwright':
            ...
            if logo_path.exists():
                ...
                logo_html = f'<div class="logo"><img src="{logo_url}" alt="Previse Systems" /></div>\n'
            else:
                logo_html = ''
            ...
            organization = metadata.get("organization", "Previse Systems")
...
<div class="disclaimer">
    <p>This document is confidential and intended solely for authorized Previse Systems personnel and approved contractors. Unauthorized distribution is prohibited.</p>
</div>'''
        ...
        default_weasyprint_css = CSS(string="""
            @page {
                ...
                @bottom-center {
                    content: "Previse Systems • Confidential • November 2025";
                    font-size: 9pt;
                    color: #888;
                }
                @bottom-right {
