...
PROFILES: Dict[str, DocumentProfile] = {
    # Default profile for the Reporting Manager / Previse documentation.
    "reporting-manager": DocumentProfile(
        name="reporting-manager",
        # Logo lives in the reporting-manager proposal assets.
        logo=_rel_from_repo_root("projects", "reporting-2.0", "proposals", "reporting-manager", "assets", "previseLogo.png"),
