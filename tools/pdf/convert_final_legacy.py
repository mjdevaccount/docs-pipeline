...
This is the original implementation of convert_final.py, preserved for:
1. Emergency fallback if pipeline module fails
2. Reference for understanding original logic
3. Backward compatibility during transition

For normal use, use convert_final.py instead (pipeline-based).
...
Architecture modules available:
...
- renderers: RendererFactory with Strategy pattern
